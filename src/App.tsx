...
import { CustomPromoBanner } from './components/CustomPromoBanner';
...
const SessionJsonToolPage = lazy(() =>
  import('./pages/SessionJsonToolPage').then((module) => ({ default: module.SessionJsonToolPage })),
);
...
function MainApp() {
  ...
  const [page, setRawPage] = useState<Page>('codex');
  const setPage = useCallback((nextPage: Page) => {
    setRawPage(nextPage === 'settings' || nextPage === 'session-json' ? nextPage : 'codex');
  }, []);
    ...
    >
      ...
      <div className="main-wrapper">
        ...
        <Suspense fallback={suspenseFallback}>
          ...
          {page === 'session-json' && <SessionJsonToolPage />}
